...
pub(crate) type ConfiguredBuilder<CB> =
...
impl NodeHooks {
    ...
    pub fn apply_to<CB>(self, mut builder: ConfiguredBuilder<CB>) -> ConfiguredBuilder<CB>
    where
    ...
    where
        ...
        R: Future<Output = eyre::Result<E>> + Send + 'static,
